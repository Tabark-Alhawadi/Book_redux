...
function Novels() {
    ...
    function getNovels() {
      axios.get(`http://localhost/Book_redux/redux_project/backend/novels.php`).then((response) => {
          setNovels(response.data);
        })
    }
    
    const deleteBook = (id) => {
      axios.delete(`http://localhost/Book_redux/redux_project/backend/books.php/${id}/delete`).then((response)=>{
        navigate('/home')
      })
    }
    ...
    function getSearch(e) {
      e.preventDefault();
      axios.get(`http://localhost/Book_redux/redux_project/backend/search.php/${search}`).then((response)=>{
